    ...
    return (
      <>
        <p>
          <Link
            className={
              activeNav.active === "header" ? "navbar__link__active" : ""
            }
            onClick={() => headerActiveHandler("header")}
            to="header"
            smooth={true}
            duration={1000}
          >
        ...
        <p>
          <Link
            className={
              activeNav.active === "services" ? "navbar__link__active" : ""
            }
            onClick={() => headerActiveHandler("services")}
            to="services"
            smooth={true}
            duration={1000}
          >
        ...
        <p>
          <Link
            className={
              activeNav.active === "skills" ? "navbar__link__active" : ""
            }
            onClick={() => headerActiveHandler("skills")}
            to="skills"
            smooth={true}
            duration={1000}
          >
        ...
        <p>
          <Link
            className={
              activeNav.active === "about" ? "navbar__link__active" : ""
            }
            onClick={() => headerActiveHandler("about")}
            to="about"
            smooth={true}
            duration={1000}
          >
        ...
        <p>
          <Link
            className={
              activeNav.active === "projects" ? "navbar__link__active" : ""
            }
            onClick={() => headerActiveHandler("projects")}
            to="projects"
            smooth={true}
            duration={1000}
          >
        ...
        <p>
          <Link
            className={
              activeNav.active === "contact" ? "navbar__link__active" : ""
            }
            onClick={() => headerActiveHandler("contact")}
            to="contact"
            smooth={true}
            duration={1000}
          >
